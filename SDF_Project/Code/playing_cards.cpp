...
void playing_cards(int num)
{
	...
	while (window_p.isOpen()) {
		...
		while (window_p.pollEvent(event)) {
			...
			if ((sf::Mouse::getPosition(window_p).x >= 45 && sf::Mouse::getPosition(window_p).x <= 150) && (sf::Mouse::getPosition(window_p).y >= 295 && sf::Mouse::getPosition(window_p).y <= 355)) {
			...
			if ((sf::Mouse::getPosition(window_p).x >= 645 && sf::Mouse::getPosition(window_p).x <= 750) && (sf::Mouse::getPosition(window_p).y >= 295 && sf::Mouse::getPosition(window_p).y <= 355)) {
